...
require_once __DIR__ . '/../models/highSchoolParticipantModel.php';
require_once __DIR__ . '/../controllers/highSchoolParticipantController.php';
...
$model = new HighSchoolParticipantModel($pdo);
// 2. Cria o Controller (dando a ele o Model)
$controller = new HighSchoolParticipantController($model);
